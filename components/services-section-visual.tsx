...
const services = [
  {
    ...
    description: "Cross-channel campaign planning and execution across Google, Meta, TikTok, and ASA — maximizing growth with data-driven targeting.",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: "Use GPT, Midjourney, Heygen, v0, and more to accelerate your workflow and creativity.",
    icon: Brain,
    gradient: "from-green-400 via-teal-500 to-blue-500",
  },
  {
    title: "E-commerce Growth",
    description: "4+ years driving revenue for online stores with conversion-focused ad funnels and remarketing strategies.",
    icon: ShoppingCart,
    gradient: "from-orange-400 via-red-500 to-pink-500",
  },
  {
    title: "Financial Ads Expertise",
    description: "Specialized in lead generation for financial products — optimizing CPL while ensuring compliance and scalability.",
    icon: DollarSign,
